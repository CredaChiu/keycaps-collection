...
export default {
  ...
  computed: {
    ...
    filteredKeyboard: {
      ...
      set(value) {
        this.keyboard = [...value] // Create a new array to ensure reactivity
      }
    }
  },
  methods: {
...
.sortable-ghost {
  opacity: 0.5;
  background-color: rgba(190, 176, 152, 0.2) !important;
  border: 2px dashed #BEB098 !important;
}
